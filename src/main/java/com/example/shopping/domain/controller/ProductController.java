 ...
 * 
 * <p>
 * 상품과 카테고리 관련 REST API 엔드포인트를 제공하는 컨트롤러입니다.
...
public class ProductController {
    ...
    public ResponseEntity<String> updateProduct(
            ...
            @RequestBody @Valid ProductDto.UpdateProduct request) {
    ...
    public ResponseEntity<List<ProductDto.CategoryResponse>> getCategoryList() {
    ...
    public ResponseEntity<String> updateCategory(
            ...
            @RequestBody @Valid ProductDto.UpdateCategory request) {
        productService.updateCategory(categoryId, request);
